...
for i in range(npang):
    ...
    w[i] = coords[i,4]
    points[i] = xpoint
    #rho, grad, gradmod = rhograd(xpoint)
    #print '%16.8f,%16.8f,%16.8f,%16.8f,%16.8f,%16.8f' % (xdeltain[0], xdeltain[1], xdeltain[2], grad[0], grad[1], grad[2])
