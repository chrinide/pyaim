...
if __name__ == '__main__':
    ...
    name = 'k2gamma'
    kpts = [0,0,0]
    lib.chkfile.save_cell(name+'.chk', scell)
    lib.chkfile.save(name+'.chk', 'kcell/kpts', kpts)
    lib.chkfile.save(name+'.chk', 'scf/mo_coeff', mf.mo_coeff)
    lib.chkfile.save(name+'.chk', 'scf/mo_occ', mf.mo_occ)
